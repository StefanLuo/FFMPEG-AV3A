 ...
 *
 * @param Renderer context
 * @param source_mode Source rendering mode, which currently includes YGG_SOURCE_SPATIALIZE(default) and
 * YGG_SOURCE_BYPASS. YGG_SOURCE_SPATIALIZE will let this sound source be spatialized, while YGG_SOURCE_BYPASS will
...
/**
 * Update source mode: between YGG_SOURCE_SPATIALIZE or YGG_SOURCE_BYPASS
 * @param ctx Renderer context
 * @param source_id The ID of the source to modify
