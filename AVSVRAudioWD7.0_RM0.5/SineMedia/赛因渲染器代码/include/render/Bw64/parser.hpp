...
namespace bw64 {
  ...
  inline std::shared_ptr<DataChunk> parseDataChunk(std::istream& /* 数据流 */,
                                                   uint32_t id, uint64_t size) {
