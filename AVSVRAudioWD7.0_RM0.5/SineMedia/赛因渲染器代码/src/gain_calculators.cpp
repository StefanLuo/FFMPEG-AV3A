#include "render/gain_calculators.hpp"
...
namespace render {
  ...
  template RENDER_EXPORT void GainCalculatorDirectSpeakers::calculate<double>(
      const DirectSpeakersTypeMetadata&, std::vector<double>&,
      const WarningCB&);
  template RENDER_EXPORT void GainCalculatorDirectSpeakers::calculate<float>(
  ...
  template RENDER_EXPORT void GainCalculatorObjects::calculate<double>(
      const ObjectsTypeMetadata&, std::vector<double>&, std::vector<double>&,
      const WarningCB&);
  template RENDER_EXPORT void GainCalculatorObjects::calculate<float>(
  ...
  template RENDER_EXPORT void GainCalculatorHOA::calculate<double>(
      const HOATypeMetadata&, std::vector<std::vector<double>>&,
      const WarningCB&);
  template RENDER_EXPORT void GainCalculatorHOA::calculate<float>(
